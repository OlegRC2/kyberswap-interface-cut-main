...
import { AlertTriangle, Info, Minus, Plus } from 'react-feather'
...
import { AMPLiquidityAndTVLContainer, ButtonWrapper, DataText, TableRow } from 'components/PoolList/styled'
